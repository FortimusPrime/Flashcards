...
# This function reads the file.txt contents and parses between German words and English words by the divisor "|" and returns a dictionary that has the content divided. 
def parse_cards(dir):
    flashcards = {}
    file = open(dir, "r")
    for line in file:
...
def flashcards_init(stdscr, chapter, stack, dir, reviewDir):
    ...
    flashcards = shuffle_dict(flashcards)
